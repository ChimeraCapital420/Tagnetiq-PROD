...
import { Shield, Scan, Sword, Store } from 'lucide-react';
      ...
      <div className="container flex h-14 items-center">
        ...
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
            ...
            <nav className="flex items-center gap-2">
                ...
                <Button asChild variant={isMarketplaceActive ? 'secondary' : 'ghost'} size="sm">
                    <Link to="/arena/marketplace">
                        <Store className="h-4 w-4" />
                        <span className="hidden sm:inline-block sm:ml-2">Market</span>
                    </Link>
                </Button>
