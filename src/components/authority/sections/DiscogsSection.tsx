...
export const DiscogsSection: React.FC<SectionProps> = ({ data }) => {
  ...
  return (
    <div className="space-y-3">
      ...
      {externalUrl && <a href={externalUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-1 text-sm text-blue-600 dark:text-blue-400 hover:underline mt-2">View on Discogs <ExternalLink className="h-3 w-3" /></a>}
    </div>
  );
};
